  ...
  return (
    <>
      ...
      `}</style>
            ...
            <div className="flex items-center justify-between h-10">
              ...
              <div className="flex items-center gap-1">
                ...
                <button
                  ...
                  className={`${isMenuOpen ? 'hidden' : 'flex'} items-center gap-1 bg-primary hover:bg-primary/90 text-white px-2 py-1 rounded-lg font-semibold text-sm transition-all duration-300 hover:shadow-apple hover:scale-105 group whitespace-nowrap`}
                  title="Neumantra IRX"
                >
        ...
        {isMenuOpen && (
          <nav
            className={`md:hidden mobile-menu-enter absolute top-full left-6 right-6 sm:left-10 sm:right-10 lg:left-20 lg:right-20 z-40 rounded-b-xl`}
            style={{
              background:
