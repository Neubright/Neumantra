            ...
            <div className="flex items-center justify-between h-14">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="flex items-center gap-1 bg-primary hover:bg-primary/90 text-white px-2 py-1 rounded-full font-semibold text-sm transition-all duration-300 hover:shadow-apple hover:scale-105 group whitespace-nowrap"
                  title="Neumantra IRX"
                >
              ...
              <Link
                to="/contact"
                onClick={handleNavClick}
                className="hidden md:block text-primary px-3 py-1.5 rounded-full font-semibold transition-all duration-300 border-2 border-red-300/60 hover:shadow-apple hover:scale-105 group"
                style={{
