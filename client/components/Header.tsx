            ...
            <div className="flex items-center justify-between h-10">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="flex items-center gap-1 bg-primary hover:bg-primary/90 text-white px-2 py-1 rounded-xl font-semibold text-sm transition-all duration-300 hover:shadow-apple hover:scale-105 group whitespace-nowrap"
                  title="Neumantra IRX"
                >
