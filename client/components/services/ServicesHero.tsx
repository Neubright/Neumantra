...
export default function ServicesHero() {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage:
          "url('https://images.pexels.com/photos/7651734/pexels-photo-7651734.jpeg?auto=compress&cs=tinysrgb&w=1200&q=40')",
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-16 md:pt-24">
        ...
        <p className="hero-subtitle text-base md:text-lg text-gray-200 mb-8 md:mb-10 max-w-3xl mx-auto">
          Comprehensive investor relations solutions tailored for India's
          dynamic mid-market
        </p>
        <SectionDivider />
      </div>
