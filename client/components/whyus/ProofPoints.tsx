      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <div className="backdrop-blur-xl bg-white/30 border-2 border-white/80 rounded-lg p-8 hover:shadow-2xl transition-all duration-300 hover:bg-white/40 hover:border-white/100">
            ...
            <h3 className="text-xl font-bold text-primary mb-6 text-center">Combined Experience</h3>
          ...
          <div className="backdrop-blur-xl bg-white/30 border-2 border-white/80 rounded-lg p-8 hover:shadow-2xl transition-all duration-300 hover:bg-white/40 hover:border-white/100">
            ...
            <h3 className="text-xl font-bold text-primary mb-6 text-center">Advisory Depth</h3>
            <ul className="space-y-4 text-gray-700 text-base">
              <li className="flex items-start">
                <span className="text-accent mr-3 flex-shrink-0 font-bold">−</span>
          ...
          <div className="backdrop-blur-xl bg-white/30 border-2 border-white/80 rounded-lg p-8 hover:shadow-2xl transition-all duration-300 hover:bg-white/40 hover:border-white/100">
            ...
            <h3 className="text-xl font-bold text-primary mb-6 text-center">Market Recognition</h3>
            <ul className="space-y-4 text-gray-700 text-base">
              <li className="flex items-start">
                <span className="text-accent mr-3 flex-shrink-0 font-bold">−</span>
