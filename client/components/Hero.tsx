      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-16 md:pt-24">
        ...
        <button className="hero-button px-3 py-2 rounded-full font-semibold transition-all duration-300 inline-flex items-center gap-3 bg-accent text-white hover:bg-red-700 shadow-lg">
          ...
          <span className="flex-shrink-0 backdrop-blur-md bg-white/25 border border-white/40 rounded-full w-10 h-10 flex items-center justify-center">
            <img src="https://cdn.builder.io/api/v1/image/assets%2Ffcfda2dcaa5c41399e1e44107fdf402a%2Fc76f1a82d1c747c78df66373da84fda9?format=webp&width=800&height=1200" alt="Arrow" style={{ filter: "brightness(0) invert(1)", maxWidth: "16px", maxHeight: "24px", objectFit: "contain" }} />
          </span>
        </button>
        <SectionDivider />
