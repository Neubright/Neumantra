...
export default function Methodology() {
  const methods = [
    ...
    },
    {
      ...
      description: "Development of a comprehensive investor relations strategy tailored to company stage and objectives: Investment Narrative Architecture (core equity story, sector positioning, growth thesis, defensibility arguments), Target Investor Mapping (institutional investors, analysts, coverage targets), Engagement Calendar (structured quarterly cadence covering earnings, analyst days, investor meets), Communication Framework (message hierarchies, disclosure protocols, FAQ development, scenario planning), and Success Metrics (defined KPIs for coverage expansion, investor base quality, perception improvement). Deliverable: Strategic IR Blueprint with 12-18 month roadmap.",
      icon: (
        <svg className="w-8 h-8 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
